...
class MultiHeadAttentionBlock(nn.Module):
    ...
    def forward(self, q, k, v, mask):
        ...
        # (Batch, h, seq_len, seq_len)  --> (Batch, seq_len, h, seq_len) --> (Batch, seq_len, d_model) 
...
def build_transformer(src_vocab_size: int, tgt_vocab_size: int, src_seq_len: int, tgt_seq_len: int, 
    ...
    for _ in range(N):
        ...
        encoder_block = EncoderBlock(encoder_self_attention, encoder_feed_forward_block, dropout)
